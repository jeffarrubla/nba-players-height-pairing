...
# Run the code 
1. Verify that you have the `requests` library installed
2. Clone the project
3. Go to the root of the project 
4. Do `python nba.py`
5. Type the sum of heights in inches that you want to find, for example `139`, and press enter.
6. The results appear on the console
